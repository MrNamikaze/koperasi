...
(1, 'rendratri@gmail.com', 356744, NULL, '2022-04-18 10:27:46', '400000', '3519155500550002', 'Rendra Tri', '087878656434', 'Jl. Matahari no.06 Madiun', '2000-07-09', 'Madiun', NULL, NULL, NULL, 'Siapa Nama Gurumu?', 'Joko', 0),
...
INSERT INTO `tb_pengajuan_kredit` (`id_pengajuan_kredit`, `id_nasabah`, `tanggal_pengajuan`, `penggunaan`, `pekerjaan`, `gaji`, `besar_pengajuan`, `bsr_pengajuan_diterima`, `tenor`, `score`, `tanggal_ubah`, `tanggal_catatan`, `status`, `ket_catatan`, `id_adminstaff`) VALUES
(1, 1, '2022-05-01', 'Beli motor', 'Petani', '1200000', 7000000, 7000000, '6 bulan', 81, '2022-05-23', '2022-05-25', 'diterima', '', 7),
(3, 2, '2022-05-07', 'Modal Usaha', 'Wiraswasta', '2000000', 5000000, 0, '6 bulan', 71, '2022-05-09', NULL, 'ditolak', '', NULL),
(4, 1, '2022-05-03', 'Renovasi Rumah', 'PNS', '3000000', 10000000, 7000000, '6 bulan', 83, '2022-06-10', '2022-06-08', 'catatan', 'memperbaiki data pada pengajuan data yang harus dilengkapi dengan alamat', NULL),
(6, 14, '2022-05-09', 'Biaya Sekolah', 'Petani', '1300000', 5000000, 5000000, '3 bulan', 84, '2022-06-10', '2022-05-23', 'catatan', 'memperbaiki data pada pengajuan data yang harus dilengkapi dengan alamat', NULL),
(9, 2, '2022-05-31', 'Biaya Sekolah', 'Kuli Bangunan', '1500000', 3000000, 0, '3 bulan', 82, NULL, NULL, 'pending', '', NULL);
